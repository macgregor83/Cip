 ...
 */
@Entity
public class ProductoEsperado implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ProductoEsperado)) {
            return false;
        }
        ProductoEsperado other = (ProductoEsperado) object;
    ...
    public String toString() {
        return "es.cip.bussines.dao.model.ProductoEsperado[ id=" + id + " ]";
    }
